...
@section('title', 'Edit Subscription Plan | EduLink')
        ...
        <div class="col-xl-8 col-lg-10 mx-auto">
            <div class="glass-card p-4 shadow-sm">
                <div class="border-bottom pb-3 mb-4">
                    <h5 class="fw-bold text-dark mb-1"><i class="bi bi-pencil-square text-primary me-2"></i>Modify Subscription Tier: {{ $plan->name }}</h5>
                    <p class="text-muted small mb-0">Modify standard pricing structures, quotas, and toggle module limits for school tenants.</p>
                </div>
                ...
                <form action="{{ route('super-admin.plans.update', $plan->id) }}" method="POST">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="text" name="name" class="form-control rounded-3" value="{{ old('name', $plan->name) }}" placeholder="e.g. Standard" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="is_active" class="form-select rounded-3" required>
                                <option value="1" {{ old('is_active', $plan->is_active ? '1' : '0') === '1' ? 'selected' : '' }}>Active / Public</option>
                                <option value="0" {{ old('is_active', $plan->is_active ? '1' : '0') === '0' ? 'selected' : '' }}>Inactive / Private</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" min="0" name="price_monthly" class="form-control rounded-end-3" value="{{ old('price_monthly', $plan->price_monthly) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light rounded-start-3">GHS</span>
                                <input type="number" step="0.01" min="0" name="price_yearly" class="form-control rounded-end-3" value="{{ old('price_yearly', $plan->price_yearly) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="max_students" class="form-control rounded-3" value="{{ old('max_students', $plan->max_students) }}" placeholder="e.g. 500 (-1 for unlimited)" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="max_staff" class="form-control rounded-3" value="{{ old('max_staff', $plan->max_staff) }}" placeholder="e.g. 50 (-1 for unlimited)" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="max_campuses" class="form-control rounded-3" value="{{ old('max_campuses', $plan->max_campuses) }}" placeholder="e.g. 2 (-1 for unlimited)" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" min="1" name="storage_gb" class="form-control rounded-start-3" value="{{ old('storage_gb', $plan->storage_gb) }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" min="0" name="sms_credits_monthly" class="form-control rounded-start-3" value="{{ old('sms_credits_monthly', $plan->sms_credits_monthly) }}" required>
                                    ...
                                    @foreach($allowedFeatures as $slug => $label)
                                        <div class="col-md-4 col-sm-6">
                                            <div class="form-check p-3 border rounded-3 bg-light bg-opacity-50">
                                                <input class="form-check-input ms-0 me-2" type="checkbox" name="features[]" value="{{ $slug }}" id="feature_{{ $slug }}" {{ in_array($slug, old('features', $plan->features ?? [])) ? 'checked' : '' }}>
                        ...
                        <div class="col-12 text-end mt-5 border-top pt-4">
                            ...
                            <button type="submit" class="btn btn-success px-4 py-2 rounded-3">
                                <i class="bi bi-save me-2"></i>Save Plan Updates
                            </button>
                        </div>
                    </div>
                </form>
