...
@section('title', 'Create Scoring Config Wizard | EduLink')
@section('header_title', 'SBA Configuration Wizard')
...
<div class="container-fluid p-0" style="max-width: 900px; margin: 0 auto;">
    ...
    <div class="wizard-card p-5">
        ...
        <form action="{{ route('school.scoring-configs.store') }}" method="POST" id="wizardForm">
            @csrf
            ...
            <div class="wizard-step-content" id="step-1">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" name="name" id="config_name" value="{{ old('name', 'Standard SHS Scoring') }}" placeholder="e.g. Standard SHS English Config" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="subject_id">
                            <option value="">Apply to all subjects at this level</option>
            ...
            <div class="wizard-step-content d-none" id="step-2">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.5" class="form-control" name="class_score_max" id="class_score_max" value="50" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.5" class="form-control" name="exam_score_max" id="exam_score_max" value="100" required>
            ...
            <div class="wizard-step-content d-none" id="step-3">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.5" class="form-control" name="class_score_weight" id="class_score_weight" value="50" oninput="updateGrandTotal()" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label font-weight-bold">Exam Score Weight (%)</label>
                        <input type="number" step="0.5" class="form-control" name="exam_score_weight" id="exam_score_weight" value="50" oninput="updateGrandTotal()" required>
                    </div>
                    <div class="col-12">
                        <div class="p-3 bg-light rounded-3 d-flex justify-content-between align-items-center">
                            <span class="font-weight-bold" style="font-weight: 600;">Report Card Grand Total Weight</span>
                            <span class="fs-4 font-weight-bold text-primary" style="font-weight: 800;" id="grand_total_display">100%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="wizard-step-content d-none" id="step-4">
                ...
                <div class="p-3 bg-light rounded-3 d-flex justify-content-between align-items-center mt-3">
                    ...
                    <span class="fs-5 font-weight-bold text-success" style="font-weight: 700;" id="components_sum_display">0 / 50</span>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="rounding_method" id="rounding_method" required>
                            <option value="ROUND" selected>Standard Rounding (ROUND)</option>
                            <option value="FLOOR">Truncate Down (FLOOR)</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="decimal_places" id="decimal_places" required>
                            <option value="0" selected>0 Decimal Places (No Decimals)</option>
                            <option value="1">1 Decimal Place (e.g. 75.5)</option>
                            <option value="2">2 Decimal Places (e.g. 75.54)</option>
                        </select>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="form-check form-switch p-3 bg-light rounded-3 d-flex align-items-center justify-content-between" style="padding-left: 3.5rem !important;">
                            ...
                            <input class="form-check-input" type="checkbox" name="is_default" id="is_default" value="1" checked>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Add default sample components on start
        addComponentRow('Exercise 1', 10, true);
        addComponentRow('Exercise 2', 10, false);
        addComponentRow('Homework', 5, false);
        addComponentRow('Project Work', 15, true);
        addComponentRow('Class Test', 10, true);
    ...
    function navigateStep(direction) {
        ...
        if (currentStep === totalSteps) {
            nextBtn.innerHTML = '<i class="bi bi-save2 me-1"></i>Create<span class="d-none d-sm-inline"> ruleset</span>';
            setupPreviewInputs();
            runSimulation();
        } else {
    ...
    function addComponentRow(name = '', maxMarks = '', isRequired = false) {
